...
const properties = [
  {
    ...
    location: { address: 'Amassoma Waterfront Road', city: 'Amassoma', state: 'Bayelsa', postalCode: '560001', country: 'Nigeria', coordinates: { lat: 4.9730872, lng: 6.1089697 } },
  ...
  },
  {
    ...
    location: { address: 'NDU Road, Amassoma', city: 'Amassoma', state: 'Bayelsa', postalCode: '560001', country: 'Nigeria', coordinates: { lat: 4.9700642, lng: 6.1020796 } },
  ...
  },
  {
    ...
    location: { address: 'University Community Road, Amassoma', city: 'Amassoma', state: 'Bayelsa', postalCode: '560001', country: 'Nigeria', coordinates: { lat: 4.9761, lng: 6.1132 } },
